...
* char* SHADE_CHANGE_DIRECTION_EXAMPLE1 = (char*)"1110000101100000 1000 0001 10000110 000000000"; // STOP + L buttons
* char* SHADE_CHANGE_DIRECTION_EXAMPLE2 = (char*)"1110000101100000 0100 0001 10000110 000000000"; // STOP + L buttons
* char* SHADE_CHANGE_DIRECTION_EXAMPLE1 = (char*)"1110000101100000 1100 0001 10000110 000000000"; // STOP + L buttons
...
#include "esphome.h"
    ...
    char* SHADE_PAIR_EXAMPLE = (char*)"10111011111011111000001010000011110101001"; // C button
    char* SHADE_DOWN_EXAMPLE = (char*)"11100001011000001111100010000000000000000";
    char* SHADE_DOWN_EXAMPLE1 = (char*)"11100001011000001000100010000000000000000";
    char* SHADE_DOWN_EXAMPLE2 = (char*)"11100001011000000100100010000000000000000";
    char* SHADE_DOWN_EXAMPLE3 = (char*)"11100001011000001100100010000000000000000";
    char* SHADE_UP_EXAMPLE = (char*)"11100001011000001111001110000000000000000";
    char* SHADE_UP_EXAMPLE1 = (char*)"11100001011000001000001110000000000000000";
    char* SHADE_UP_EXAMPLE2 = (char*)"11100001011000000100001110000000000000000";
    char* SHADE_UP_EXAMPLE3 = (char*)"11100001011000001100001110000000000000000";
    char* SHADE_STOP_EXAMPLE = (char*)"11100001011000001111101010000000000000000";
    //#define SHADE_DOWN_EXAMPLE                 "11100001011000000100100010000000000000000" // DOWN button
    //#define SHADE_STOP_EXAMPLE                 "11100001011000000100101010000000000000000" // STOP button
    //#define SHADE_UP_EXAMPLE                   "11100001011000000100001110000000000000000" // UP button
    char* SHADE_LIMIT_EXAMPLE = (char*)"10111011111011111000010010000011110100101"; // L button
    char* SHADE_CHANGE_DIRECTION_EXAMPLE = (char*)"10111011111011111000000110000011110101111"; // STOP + L buttons

    char* SHADE_CHANGE_DIRECTION_1 = (char*)"11100001011000001000000110000110000000000"; // STOP + L buttons
    char* SHADE_CHANGE_DIRECTION_2 = (char*)"11100001011000000100000110000110000000000"; // STOP + L buttons
    char* SHADE_CHANGE_DIRECTION_3 = (char*)"11100001011000001100000110000110000000000"; // STOP + L buttons


    #define TRANSMIT_PIN                       23   // We'll use digital 13 for transmitting
    ...
    char* MY_REMOTE_ID_1 = (char*)"1110000101100000";    // Enter your 16 bit remote ID here or make up a binary number and confirm/pair it with the motor
    char* DEFAULT_CHANNEL = (char*)"1111";                // Channel information is only required for multichannel remotes like the BF-305
    char* DEFAULT_REMOTE_MODEL = (char*)"10000000";            // We default to BF-301, but this is actually ignored by motors and could be plain zeroes
    char* DEFAULT_TRAILING_BITS = (char*)"000000000";           // Last 9 bits of the command. What do they mean? No idea. Again, ignored by motors.
    char* COMMAND_DOWN = (char*)"1000";                // Remote button DOWN
    // 1110000101100000 0100 0011 10000000 100011011
    char* COMMAND_UP = (char*)"0011";                // Remote button UP
    // 1110000101100000 0100 1010 10000000 100001001
    char* COMMAND_STOP = (char*)"1010";                // Remote button STOP
    char* COMMAND_PAIR = (char*)"0010";                // Remote button C
    char* COMMAND_PROGRAM_LIMITS = (char*)"0100";                // Remote button L
    char* COMMAND_CHANGE_ROTATION_DIRECTION = (char*)"0001";                // Remote buttons STOP + L
